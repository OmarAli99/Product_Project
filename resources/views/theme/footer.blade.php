        ...
        <div class="col-lg-4  col-md-6 col-sm-6">
          <div class="single-footer-widget">
            ...
            <div class="" id="mc_embed_signup">
                ...
                @endif
              <form  action="{{ route('script.store') }}" method="post" class="form-inline">
              @csrf
                <div class="d-flex flex-row">
                  ...
                  <button type="submit" class="click-btn1 btn btn-default"><span class="lnr lnr-arrow-right"></span></button>
                </div>
                   @error('email')
